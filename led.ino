...

{
  ...
  case 0xFFE21D: Serial.println("On"); break;
  case 0xFF629D: Serial.println("B-"); break;
  case 0xFF22DD: Serial.println("Couleur chaude");    break;
  case 0xFF02FD: Serial.println("Flash");    break;
  case 0xFFC23D: Serial.println("Off");   break;
  case 0xFFE01F: Serial.println("change blop");    break;
  case 0xFFA857: Serial.println("change dégradé");    break;
  case 0xFF906F: Serial.println("Timer");    break;
  case 0xFF9867: Serial.println("Tons vert");    break;
  case 0xFFB04F: Serial.println("Tons bleu");    break;
  case 0xFF6897: Serial.println("Tons rouge");    break;
  case 0xFF30CF: Serial.println("rouge");    break;
  case 0xFF18E7: Serial.println("vert");    break;
  case 0xFF7A85: Serial.println("bleu");    break;
  case 0xFF10EF: Serial.println("orange");    break;
  case 0xFF38C7: Serial.println("vert eau");    break;
  case 0xFF5AA5: Serial.println("bleu ciel");    break;
...
void changeColor() {
 ...
 // { translateIR();
  ...
  for (int i = 0; i <= 255; i++) {
     for (int k=0; k <= LED_COUNT; k++){
    leds[k] = CRGB(255, i, 0); } // Rouge à Jaune
      FastLED.show();
  ...
  for (int i = 0; i <= 255; i++) {
     for (int k=0; k <= LED_COUNT; k++){
    leds[k] = CRGB(255 - i, 255, 0); } // Jaune à Vert
      FastLED.show();
      delay(5);
  }
  ...
  for (int i = 0; i <= 255; i++) {
     for (int k=0; k <= LED_COUNT; k++){
    leds[k] = CRGB(0, 255, i);}  // Vert à Cyan
      FastLED.show();
 delay(5);
  }
  ...
  for (int i = 0; i <= 255; i++) {
     for (int k=0; k <= LED_COUNT; k++){
    leds[k] = CRGB(0, 255 - i, 255); } // Cyan à Bleu
      FastLED.show();
delay(5);
  }
  ...
  for (int i = 0; i <= 255; i++) {
     for (int k=0; k <= LED_COUNT; k++){
    leds[k] = CRGB(i, 0, 255); } // Bleu à Magenta
      FastLED.show();
 delay(5);
  }
  ...
  for (int i = 0; i <= 255; i++) {
     for (int k=0; k <= LED_COUNT; k++){
    leds[k] = CRGB(255, 0,  255 - i);}  // Magenta à Rouge
      FastLED.show();
  delay(5);
   }}
//irrecv.resume();
